...
public class App2Solution {
  public static void main(String[] args) throws Exception {
    ...
    handler.addFilter(ParamsFilter.class, "/d/*", EnumSet.of(DispatcherType.REQUEST));
    handler.addFilter(ParamsFilter.class, "/e/*", EnumSet.of(DispatcherType.REQUEST));
    handler.addFilter(ParamsFilter.class, "/f/*", EnumSet.of(DispatcherType.REQUEST));
